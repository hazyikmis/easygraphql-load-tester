...
module.exports = /** @class */ (function () {
    function LoadTesting(schema, args) {
        ...
        this.arguments = args;
        this.queryField = ((_b = (_a = this.schema.schemaDefinition) === null || _a === void 0 ? void 0 : _a.query) === null || _b === void 0 ? void 0 : _b.field) || 'Query';
        this.mutationField =
            ((_d = (_c = this.schema.schemaDefinition) === null || _c === void 0 ? void 0 : _c.mutation) === null || _d === void 0 ? void 0 : _d.field) || 'Mutation';
    }
    LoadTesting.prototype.artillery = function (options) {
        if (options === void 0) { options = {}; }
        var _a, _b, _c, _d, _e, _f;
        var queries = this.createQueries({
            queries: (_a = options) === null || _a === void 0 ? void 0 : _a.customQueries,
            selectedQueries: (_b = options) === null || _b === void 0 ? void 0 : _b.selectedQueries,
            withMutations: (_c = options) === null || _c === void 0 ? void 0 : _c.withMutations,
            onlyCustomQueries: (_d = options) === null || _d === void 0 ? void 0 : _d.onlyCustomQueries,
        });
        if ((_e = options) === null || _e === void 0 ? void 0 : _e.queryFile) {
            var queryFileName = 'easygraphql-load-tester-queries.json';
            var filePath = ((_f = options) === null || _f === void 0 ? void 0 : _f.queryFilePath) ? path_1.default.join(options.queryFilePath, queryFileName)
    ...
    LoadTesting.prototype.k6 = function (fileName, options) {
        ...
        var selectedVus = ((_e = options) === null || _e === void 0 ? void 0 : _e.vus) || '';
        var selectedDuration = ((_f = options) === null || _f === void 0 ? void 0 : _f.duration) || '';
        var iterations = ((_h = (_g = options) === null || _g === void 0 ? void 0 : _g.iterations) === null || _h === void 0 ? void 0 : _h.toString()) || '';
        fs_1.default.writeFileSync(queryFileName, JSON.stringify(queries));
        var outArgs = options.out ? options.out.map(function (out) { return "--out " + out; }) : [];
        var k6Process = child_process_1.spawn('k6 run', __spreadArrays(outArgs, [fileName]), {
            stdio: 'inherit',
            shell: true,
            env: {
        ...
        k6Process.on('exit', function () {
            var _a;
            if (!((_a = options) === null || _a === void 0 ? void 0 : _a.queryFile)) {
    ...
    LoadTesting.prototype.createQueries = function (_a) {
        var _this = this;
        var _b = _a === void 0 ? {} : _a, queries = _b.queries, selectedQueries = _b.selectedQueries, withMutations = _b.withMutations, onlyCustomQueries = _b.onlyCustomQueries, _c = _b.maxDeepLevel, maxDeepLevel = _c === void 0 ? 5 : _c;
        var loadTestQueries = [];
        if (queries &&
            selectedQueries &&
        ...
        if (queries) {
            loadTestQueries = queries.map(function (query) {
                ...
                var operationNode = graphql_1.getOperationAST(parsedQuery, null);
                var name = ((_b = (_a = operationNode) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.value) ||
                    ((_c = operationNode) === null || _c === void 0 ? void 0 : _c.selectionSet.selections[0]).name.value;
                if (Array.isArray(_this.arguments[name])) {
                    return _this.arguments[name].map(function (val) {
                        var _a;
                        return ({
                            name: name,
                            operation: (_a = operationNode) === null || _a === void 0 ? void 0 : _a.operation,
                            query: query,
                            variables: val || {},
                        });
                    });
                ...
                return {
                    name: name,
                    operation: (_d = operationNode) === null || _d === void 0 ? void 0 : _d.operation,
                    query: query,
        ...
        if (onlyCustomQueries && queries) {
            ...
            schemaDefinitions.forEach(function (schemaDefinition) {
                _this.schema[schemaDefinition.definition].fields.forEach(function (query) {
                    var _a;
                    if (!(((_a = selectedQueries) === null || _a === void 0 ? void 0 : _a.length) && selectedQueries.indexOf(query.name) < 0)) {
                        loadTestQueries.push(_this.createOperation(query, schemaDefinition.isMutation, maxDeepLevel));
                    }
                });
            });
            loadTestQueries = lodash_flatten_1.default(loadTestQueries);
    ...
    LoadTesting.prototype.createOperation = function (query, isMutation, maxDeepLevel) {
        var _this = this;
        var queryHeader = query.name;
        var name = query.name;
        var operationName = query.name.toUpperCase();
        if (query.arguments.length) {
            var createdArgs = utils_1.createQueryArguments(query.arguments, this.arguments[query.name], query.name);
        ...
        if (nestedType.type === 'UnionTypeDefinition') {
            ...
            nestedType.types.forEach(function (type) {
                ...
                unionQueries_1.push(utils_1.createUnionQuery(newNestedType, _this.schema, type, maxDeepLevel));
            });
            return utils_1.createQuery({
            ...
            return nestedType.fields.map(function (field) {
                var createdField = utils_1.getField(field, _this.schema, maxDeepLevel);
                if (createdField) {
